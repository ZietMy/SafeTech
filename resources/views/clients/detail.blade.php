...
<link rel="stylesheet" href="{{ asset('assets/clients/css/detail.css') }}">
    <div class="container">
        <div class="row">
            ...
            <div class="col-2">
                <img src="{{$productId->image}}" alt="ảnh" style="width:100%;padding-bottom:30px">
                <img src="{{$productId->image}}" alt="ảnh" style="width:100%">
            </div>
            <div class="col-4">
                <img src="{{$productId->image}}" alt="ảnh" style="width:100%">
            </div>
            <div class="col-4">
                ...
                <div class="d-flex mt-3">
                    <div class="cont">
                        <div class="crtdiv" style="margin-right: 30px">
                           <button id="btn" type="button" class="cart" ><i class="fa fa-shopping-cart" aria-hidden="true"></i> Add to cart</button>
                        </div>
                     </div>
                     <div class="cont">
                        <div class="crtdiv1">
                           <button id="btn" type="button" class="cart1"><i class="fa fa-check" aria-hidden="true"></i> Go to checkout</button>
                        </div>
                     </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="Frame626" style="height: 103px; flex-direction: column; justify-content: flex-start; align-items: flex-start; gap: 24px; display: inline-flex">
            <div class="Frame625" style="justify-content: flex-start; align-items: center; gap: 16px; display: inline-flex">
              ...
              <div class="TodayS" style="color: #DB4444; font-size: 16px; font-family: Poppins; font-weight: 600; line-height: 20px; word-wrap: break-word">Related</div>
            </div>
          </div>
          <div class="row">
